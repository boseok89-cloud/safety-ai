...
const INDUSTRY_SCENARIOS = {
  "건설업": {
    ...
    accidentCases: [
      {
        title: "비계 발판 탈락으로 인한 추락 사망",
        date: "2024-03", industry: "건설업", severity: "사망",
        situation: "지상 8m 높이 비계에서 거푸집 해체 작업 중 발판이 탈락하여 근로자 추락",
        cause: "비계 발판 결속 불량 / 안전대 미착용 / 작업 전 점검 미실시",
        prevention: "작업 전 비계 점검 의무화 / 안전대 부착설비 설치 / 관리감독자 상주",
        keyword: "추락·비계",
      },
      {
        title: "이동식크레인 전도로 협착 사망",
        date: "2024-06", industry: "건설업", severity: "사망",
        situation: "연약지반에서 이동식크레인으로 철골 양중 중 크레인 전도, 운전원 협착",
        cause: "아웃트리거 미설치 / 지반 지내력 미확인 / 작업반경 내 근로자 출입",
        prevention: "지반 조사 후 아웃트리거 완전 전개 / 작업반경 통제구역 설정 / 신호수 배치",
        keyword: "협착·크레인",
      },
      {
        title: "굴착면 붕괴로 매몰 사망",
        date: "2024-09", industry: "건설업", severity: "사망",
        situation: "토사 굴착 작업 중 굴착면 붕괴로 근로자 2명 매몰",
        cause: "흙막이 미설치 / 굴착면 기울기 기준 미준수 / 강우 후 지반 약화 미확인",
        prevention: "굴착 깊이 2m 초과 시 흙막이 의무 설치 / 강우 후 지반 상태 점검 절차 수립",
        keyword: "붕괴·굴착",
      },
    ],
  },
  "제조업": {
    ...
    accidentCases: [
      {
        title: "프레스 금형 교체 중 협착 사망",
        date: "2024-04", industry: "제조업", severity: "사망",
        situation: "프레스 금형 교체 작업 중 슬라이드가 하강하여 작업자 손 협착",
        cause: "안전블록 미삽입 / 양수조작식 방호장치 임의 해제 / 작업절차서 미준수",
        prevention: "금형 교체 시 안전블록 의무 삽입 / 방호장치 해제 잠금장치 설치 / 위험성평가 실시",
        keyword: "협착·프레스",
      },
      {
        title: "도장부스 유기용제 폭발 화재",
        date: "2024-07", industry: "제조업", severity: "중상",
        situation: "도장부스 내 유기용제 스프레이 도장 중 정전기 점화로 폭발 발생",
        cause: "방폭 조명 미설치 / 국소배기장치 미작동 / 정전기 방지 미접지",
        prevention: "방폭형 전기설비 설치 / 국소배기장치 가동 확인 후 작업 / 정전기 접지 의무화",
        keyword: "화재·폭발",
      },
      {
        title: "컨베이어 청소 중 끼임 사망",
        date: "2024-11", industry: "제조업", severity: "사망",
        situation: "컨베이어 벨트 청소 중 가동 상태에서 벨트와 롤러 사이 끼임",
        cause: "잠금·표지 절차(LOTO) 미이행 / 청소 중 기계 정지 규정 없음",
        prevention: "청소·정비 전 LOTO(잠금·표지) 의무화 / 청소 전용 정지 절차 수립 및 교육",
        keyword: "끼임·컨베이어",
      },
    ],
  },
  "물류·유통업": {
    ...
    accidentCases: [
      {
        title: "지게차 후진 중 보행자 충돌 사망",
        date: "2024-05", industry: "물류·유통업", severity: "사망",
        situation: "창고 내 지게차 후진 중 보행 근로자를 미발견하고 충돌",
        cause: "보행자·차량 통로 미분리 / 후방카메라 미설치 / 신호수 미배치",
        prevention: "차량·보행자 통로 완전 분리 / 후방감지센서 설치 / 교차로 안전거울 설치",
        keyword: "충돌·지게차",
      },
      {
        title: "고층 랙 적재물 낙하 골절",
        date: "2024-08", industry: "물류·유통업", severity: "중상",
        situation: "5단 랙 최상단 작업 중 불안정 적재물이 낙하하여 하부 작업자 충격",
        cause: "적재 중량 초과 / 랙 안전핀 미설치 / 작업구역 출입통제 없음",
        prevention: "랙 최대 적재하중 표시 및 준수 / 랙 안전핀 설치 의무화 / 작업 중 하부 출입금지",
        keyword: "낙하·랙",
      },
    ],
  },
  "서비스업": {
    ...
    accidentCases: [
      {
        title: "이동식 사다리 전도 추락 사망",
        date: "2024-06", industry: "서비스업", severity: "사망",
        situation: "건물 내부 천장 점검 중 이동식 사다리 전도로 추락",
        cause: "사다리 고정 미실시 / 안전모 미착용 / 1인 단독 작업",
        prevention: "사다리 전도방지 고정 의무 / 2인 1조 작업 / 안전모·안전대 착용 의무화",
        keyword: "추락·사다리",
      },
    ],
  },
  "화학·석유업": {
    ...
    accidentCases: [
      {
        title: "밀폐공간 질소 치환 중 질식 사망",
        date: "2024-03", industry: "화학·석유업", severity: "사망",
        situation: "탱크 내부 정비를 위해 질소 치환 후 산소 농도 미확인 상태로 입장하여 질식",
        cause: "산소 농도 측정 미실시 / 감시인 미배치 / 공기호흡기 미착용",
        prevention: "밀폐공간 진입 전 산소농도(18% 이상) 측정 의무 / 감시인 배치 / 공기호흡기 착용",
        keyword: "질식·밀폐공간",
      },
      {
        title: "배관 수리 중 고압 화학물질 누출 화상",
        date: "2024-10", industry: "화학·석유업", severity: "중상",
        situation: "운전 중 배관 플랜지 볼트 조임 작업 중 고압 화학물질 분출",
        cause: "운전 중 정비 실시 / 잠금·표지 절차 미이행 / 보호복 미착용",
        prevention: "배관 정비 전 완전 차단 및 LOTO 절차 이행 / 내화학성 보호복·보안면 착용 의무화",
        keyword: "누출·화상",
      },
    ],
  },
...
const STEPS = [
  {
    ...
    prompt: "고용노동부 고시 제2024-76호 기준 위험성평가 사전준비 단계 문서 작성. 포함: 사업장 기본정보, 법적근거(산업안전보건법 제36조), 평가팀 구성 및 역할, 가능성×중대성 위험성 판단 기준 매트릭스(3×3), 수집자료 목록(재해사례/아차사고/공정정보), 평가일정. 전문적으로 한국어로.",
  },
  {
  ...
  },
  {
    ...
    prompt: "고용노동부 고시 제2024-76호 기준 위험성 결정 단계 문서 작성. 핵심: 각 위험 시나리오별로 (1)가능성(상3/중2/하1) (2)중대성(상3/중2/하1) (3)위험성=가능성×중대성 (4)허용여부를 결정하는 표 작성. 포함: 위험성 결정 매트릭스표, 시나리오별 상세 결정 근거, 허용불가 위험성 목록(즉시조치 필요), 중대성 판단기준(사망/중상/경상). 전문적으로 한국어로.",
    hasScenario: true,
  },
  {
...
function downloadWordDoc(content, title, baseInfo) {
  try {
    ...
    children.push(new Paragraph({ children: [new TextRun({ text: "■ 사업장 기본정보", bold: true, size: 24, font: "맑은 고딕" })], spacing: { before: 200, after: 100 } }));
    ...
    children.push(new Paragraph({ children: [new TextRun({ text: "■ 평가 내용", bold: true, size: 24, font: "맑은 고딕" })], spacing: { before: 300, after: 100 } }));
    content.split("\n").forEach(line => {
      if (!line.trim()) { children.push(new Paragraph({ spacing: { after: 60 } })); return; }
      const isHeader = line.startsWith("#") || (line.match(/^\d+\./) && line.length < 50);
      const cleanLine = line.replace(/^#+\s*/, "").replace(/\*\*/g, "");
      children.push(new Paragraph({ heading: isHeader ? HeadingLevel.HEADING_2 : undefined, children: [new TextRun({ text: cleanLine, bold: isHeader, size: isHeader ? 24 : 20, font: "맑은 고딕" })], spacing: { before: isHeader ? 200 : 60, after: 60 } }));
    });
    children.push(new Paragraph({ spacing: { before: 400 } }));
    children.push(new Table({
      width: { size: 100, type: WidthType.PERCENTAGE },
      rows: [
        new TableRow({ children: ["작성자","검토자","승인자"].map(t => new TableCell({ margins: cellMargins, shading: { fill: "D5E8F0" }, borders: { top: borderSetting, bottom: borderSetting, left: borderSetting, right: borderSetting }, children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun({ text: t, bold: true, size: 20, font: "맑은 고딕" })] })] })) }),
        new TableRow({ children: [0,1,2].map(() => new TableCell({ margins: cellMargins, borders: { top: borderSetting, bottom: borderSetting, left: borderSetting, right: borderSetting }, children: [new Paragraph({ children: [new TextRun({ text: " ", size: 40 })] })] })) }),
      ],
    }));
    children.push(new Paragraph({ children: [new TextRun({ text: "※ AI 초안입니다. 안전관리자가 현장 상황에 맞게 반드시 검토·수정 후 사용하세요.", size: 18, color: "FF6B00", font: "맑은 고딕" })], spacing: { before: 200 } }));
    const doc = new Document({
      styles: { default: { document: { run: { font: "맑은 고딕", size: 20 } } }, paragraphStyles: [
    ...
    Packer.toBlob(doc).then(blob => {
      ...
      a.href = url;
      a.download = `위험성평가_${title.replace(/[\s\.]/g,"_")}_${(baseInfo.company||"사업장").replace(/[\s\.]/g,"_")}_${new Date().toISOString().slice(0,10).replace(/-/g,"")}.docx`;
      document.body.appendChild(a); a.click(); document.body.removeChild(a); URL.revokeObjectURL(url);
    });
  } catch (e) { alert("워드 문서 생성 중 오류: " + e.message); }
}

function downloadSirenDoc(caseData) {
  try {
    const { Document, Packer, Paragraph, TextRun, Table, TableRow, TableCell, AlignmentType, BorderStyle, WidthType, ShadingType } = window.docx;
    const bR = { style: BorderStyle.SINGLE, size: 4, color: "DC2626" };
    const bG = { style: BorderStyle.SINGLE, size: 1, color: "CCCCCC" };
    const m = { top: 120, bottom: 120, left: 160, right: 160 };
    const children = [];
    children.push(new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun({ text: "🚨  중대재해 사이렌  —  사고사례 즉시공유", bold: true, size: 38, font: "맑은 고딕", color: "DC2626" })], spacing: { before: 0, after: 180 } }));
    children.push(new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun({ text: `${caseData.industry}  |  ${caseData.date}  |  피해: ${caseData.severity}`, size: 22, font: "맑은 고딕", color: "7F1D1D" })], spacing: { after: 240 } }));
    children.push(new Table({
      width: { size: 100, type: WidthType.PERCENTAGE },
      rows: [
        new TableRow({ children: [ new TableCell({ columnSpan: 2, margins: m, shading: { fill: "7F1D1D", type: ShadingType.CLEAR }, borders: { top: bR, bottom: bR, left: bR, right: bR }, children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun({ text: `⚠  ${caseData.title}`, bold: true, size: 26, font: "맑은 고딕", color: "FFFFFF" })] })] }) ] }),
        new TableRow({ children: [
          new TableCell({ margins: m, shading: { fill: "FEE2E2" }, borders: { top: bG, bottom: bG, left: bR, right: bG }, children: [new Paragraph({ children: [new TextRun({ text: "발생 경위", bold: true, size: 22, font: "맑은 고딕", color: "991B1B" })] })] }),
          new TableCell({ margins: m, borders: { top: bG, bottom: bG, left: bG, right: bR }, children: [new Paragraph({ children: [new TextRun({ text: caseData.situation, size: 21, font: "맑은 고딕" })] })] }),
        ]}),
        new TableRow({ children: [
          new TableCell({ margins: m, shading: { fill: "FEF9C3" }, borders: { top: bG, bottom: bG, left: bR, right: bG }, children: [new Paragraph({ children: [new TextRun({ text: "원인 분석", bold: true, size: 22, font: "맑은 고딕", color: "92400E" })] })] }),
          new TableCell({ margins: m, borders: { top: bG, bottom: bG, left: bG, right: bR }, children: [new Paragraph({ children: [new TextRun({ text: caseData.cause, size: 21, font: "맑은 고딕" })] })] }),
        ]}),
        new TableRow({ children: [
          new TableCell({ margins: m, shading: { fill: "DCFCE7" }, borders: { top: bG, bottom: bR, left: bR, right: bG }, children: [new Paragraph({ children: [new TextRun({ text: "재발방지 대책", bold: true, size: 22, font: "맑은 고딕", color: "166534" })] })] }),
          new TableCell({ margins: m, borders: { top: bG, bottom: bR, left: bG, right: bR }, children: [new Paragraph({ children: [new TextRun({ text: caseData.prevention, size: 21, font: "맑은 고딕" })] })] }),
        ]}),
      ],
    }));
    children.push(new Paragraph({ spacing: { before: 280 } }));
    children.push(new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun({ text: "지금 당장 현장에 공유하세요!  같은 사고가 반복되지 않도록.", bold: true, size: 24, font: "맑은 고딕", color: "DC2626" })] }));
    const doc = new Document({ sections: [{ properties: { page: { size: { width: 16838, height: 11906 }, margin: { top: 720, right: 720, bottom: 720, left: 720 } } }, children }] });
    Packer.toBlob(doc).then(blob => {
      const url = URL.createObjectURL(blob);
      const a = document.createElement("a");
      a.href = url;
      a.download = `중대재해사이렌_${caseData.keyword}_${new Date().toISOString().slice(0,10).replace(/-/g,"")}.docx`;
      document.body.appendChild(a); a.click(); document.body.removeChild(a); URL.revokeObjectURL(url);
    });
  } catch (e) { alert("문서 생성 중 오류: " + e.message); }
}
...
export default function App() {
  ...
  const [sheets, setSheets] = useState([
    { id: 1, workArea: "", workType: "", equipment: "", materials: "", envFactors: "", currentSafety: "", result: "" }
  ]);
  ...
  // 위험성평가 4단계 이상 완료 시 업종 연계 사이렌 자동 세팅
  useEffect(() => {
    if (completedSteps.length >= 4 && baseInfo.industry) {
      const matchKey = Object.keys(INDUSTRY_SCENARIOS).find(k =>
        baseInfo.industry.includes(k) || baseInfo.industry.replace("업","") === k.replace("업","")
      );
  ...
  const callAI = async (prompt) => {
    ...
    try {
      const res = await fetch("/api/chat", {
        ...
        body: JSON.stringify({ model: "claude-sonnet-4-6", max_tokens: 1500, system: prompt, messages: [{ role: "user", content: `다음 정보로 문서를 작성해주세요:\n\n${info}` }] }),
      });
  ...
  const addSheet = () => {
    ...
    setSheets(prev => [...prev, { id: newId, workArea: "", workType: "", equipment: "", materials: "", envFactors: "", currentSafety: "", result: "" }]);
  ...
  const callAIForSheet = async (sheet) => {
    ...
    try {
      const res = await fetch("/api/chat", {
        method: "POST", headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ model: "claude-sonnet-4-6", max_tokens: 1500, system: STEPS[1].prompt, messages: [{ role: "user", content: `다음 공정의 위험요인을 파악해주세요:\n\n${info}` }] }),
      });
      const d = await res.json();
      const text = d.content?.map(b => b.text || "").join("") || "오류가 발생했습니다.";
      ...
      const newH = [entry, ...history].slice(0, 20);
      setHistory(newH); await saveStorage("eval-history", newH);
  ...
  const getSirenCases = () => {
    ...
    if (baseInfo.industry) {
      ...
      if (matchKey) return INDUSTRY_SCENARIOS[matchKey]?.accidentCases || [];
    }
  ...
  const getRelatedCases = () => {
    ...
    const matchKey = Object.keys(INDUSTRY_SCENARIOS).find(k => baseInfo.industry.includes(k) || baseInfo.industry.replace("업","") === k.replace("업",""));
    return matchKey ? (INDUSTRY_SCENARIOS[matchKey]?.accidentCases || []) : [];
  };
            ...
            <button key={tmpl.id} onClick={async () => { setSelectedTemplate(tmpl); await saveStorage("selected-template", tmpl); }} style={{ width: "100%", background: "#fff", border: `2px solid ${tmpl.color}30`, borderRadius: 14, padding: "16px", marginBottom: 10, display: "flex", alignItems: "flex-start", gap: 14, cursor: "pointer", textAlign: "left", boxShadow: "0 2px 8px rgba(0,0,0,0.05)" }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ display: "flex", gap: 5, flexWrap: "wrap" }}>
                  {tmpl.tags.map(t => <span key={t} style={{ fontSize: 10, fontWeight: 700, color: tmpl.color, background: `${tmpl.color}12`, padding: "2px 8px", borderRadius: 20 }}>{t}</span>)}
                </div>
              </div>
        ...
        <div style={{ background: `linear-gradient(135deg, ${C.navy}, ${C.blue})`, padding: "20px 16px 16px" }}>
          <div style={{ maxWidth: 560, margin: "0 auto" }}>
            ...
            <div style={{ display: "flex", gap: 4 }}>
              {STEPS.map((s, i) => <div key={s.id} style={{ flex: 1, height: 4, borderRadius: 3, background: completedSteps.includes(i+1) ? C.green : "rgba(255,255,255,0.18)" }} />)}
            </div>
          </div>
        </div>
        ...
        {tab === "assessment" && (
          <div style={{ maxWidth: 560, margin: "0 auto", padding: "10px 14px 28px" }}>
            {completedSteps.length > 0 && (
              <button onClick={() => { const allText = STEPS.filter(s => results[s.id]).map(s => `=== ${s.icon} STEP ${s.id}: ${s.title} ===\n\n${results[s.id]}`).join("\n\n\n"); downloadWordDoc(allText, "위험성평가 전체", baseInfo); }} style={{ width: "100%", padding: "13px", marginBottom: 12, background: "linear-gradient(135deg, #1d4ed8, #3b82f6)", border: "none", borderRadius: 13, color: "#fff", fontSize: 14, fontWeight: 700, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }}>
                <span style={{ fontSize: 18 }}>📄</span> 전체 워드 문서 다운로드 ({completedSteps.length}/6 완료)
              </button>
            )}
            {/* 위험성평가 완료 후 사이렌 연계 배너 */}
            {linkedSirenCases.length > 0 && (
              <div style={{ background: "linear-gradient(135deg, rgba(220,38,38,0.08), rgba(220,38,38,0.03))", border: "2px solid rgba(220,38,38,0.25)", borderRadius: 13, padding: "12px 14px", marginBottom: 12 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8 }}>
                  ...
                  <div>
                    <div style={{ fontSize: 13, fontWeight: 800, color: C.siren }}>중대재해 사이렌 연계</div>
                    <div style={{ fontSize: 11, color: "#7f1d1d" }}>위험성평가 완료! 동종 업종 실제 사고사례를 바로 현장 공유하세요</div>
                  </div>
                </div>
                <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
                  {linkedSirenCases.map((c, i) => (
                    <button key={i} onClick={() => downloadSirenDoc(c)} style={{ padding: "5px 10px", background: "rgba(220,38,38,0.1)", border: "1px solid rgba(220,38,38,0.3)", borderRadius: 8, color: C.siren, fontSize: 11, fontWeight: 700, cursor: "pointer" }}>📄 {c.keyword}</button>
                  ))}
                </div>
              </div>
            )}
        ...
        {tab === "siren" && (
          <div style={{ maxWidth: 560, margin: "0 auto", padding: "10px 14px 28px" }}>
            <div style={{ background: "linear-gradient(135deg, #7f1d1d, #dc2626)", borderRadius: 14, padding: "18px", marginBottom: 14, textAlign: "center" }}>
              ...
              <div style={{ color: "rgba(255,255,255,0.75)", fontSize: 12, lineHeight: 1.6 }}>실제 중대재해 사례를 원시트(A4 가로)로 즉시 다운로드<br/>인쇄해서 현장에 바로 공유하세요</div>
            </div>
              ...
              sirenCases.map((c, i) => (
                <div key={i} style={{ background: "#fff", border: "2px solid rgba(220,38,38,0.12)", borderLeft: `4px solid ${C.siren}`, borderRadius: 14, padding: "16px", marginBottom: 12 }}>
                  ...
                  <div style={{ marginBottom: 8 }}>
                    <div style={{ fontSize: 11, fontWeight: 700, color: C.siren, marginBottom: 3 }}>🔴 발생 경위</div>
                    <div style={{ fontSize: 12, color: "#374151", lineHeight: 1.6, background: "rgba(220,38,38,0.04)", padding: "8px 10px", borderRadius: 8 }}>{c.situation}</div>
                  </div>
                  <div style={{ marginBottom: 8 }}>
                    <div style={{ fontSize: 11, fontWeight: 700, color: C.amber, marginBottom: 3 }}>⚠️ 원인 분석</div>
                    <div style={{ fontSize: 12, color: "#374151", lineHeight: 1.6, background: "rgba(245,158,11,0.05)", padding: "8px 10px", borderRadius: 8 }}>{c.cause}</div>
                  </div>
                  <div style={{ marginBottom: 12 }}>
                    <div style={{ fontSize: 11, fontWeight: 700, color: C.green, marginBottom: 3 }}>✅ 재발방지 대책</div>
                    <div style={{ fontSize: 12, color: "#374151", lineHeight: 1.6, background: "rgba(34,197,94,0.05)", padding: "8px 10px", borderRadius: 8 }}>{c.prevention}</div>
                  </div>
                  <button onClick={() => downloadSirenDoc(c)} style={{ width: "100%", padding: "11px", background: `linear-gradient(135deg, ${C.siren}, #b91c1c)`, border: "none", borderRadius: 10, color: "#fff", fontSize: 13, fontWeight: 700, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 6 }}>
                    <span>📄</span> 원시트 워드 다운로드 · 즉시 현장 공유
                  </button>
                </div>
              ))
            )}
          ...
          {isStep2 && (
            <div>
              ...
              <button onClick={async () => {
                ...
                setResult(allResult); setResults(prev => ({ ...prev, [2]: allResult }));
      ...
      <div style={{ minHeight: "100vh", background: C.bg, fontFamily: "'Noto Sans KR', sans-serif" }}>
        ...
        <div style={{ background: `linear-gradient(135deg, ${C.navy}, ${C.blue})`, padding: "14px 16px", position: "sticky", top: 0, zIndex: 50 }}>
          <div style={{ maxWidth: 560, margin: "0 auto", display: "flex", alignItems: "center", gap: 10 }}>
            ...
            {!loading && result && <button onClick={() => navigator.clipboard.writeText(result)} style={{ background: "rgba(255,255,255,0.15)", border: "1px solid rgba(255,255,255,0.3)", borderRadius: 8, padding: "6px 10px", color: "#fff", fontSize: 11, fontWeight: 600, cursor: "pointer" }}>📋 복사</button>}
          </div>
        </div>
                ...
                <div style={{ background: "linear-gradient(135deg, rgba(220,38,38,0.07), rgba(220,38,38,0.03))", border: "2px solid rgba(220,38,38,0.2)", borderRadius: 13, padding: "12px 14px", marginBottom: 12 }}>
                  ...
                  <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
                    {relatedCases.slice(0, 3).map((c, i) => (
                      <button key={i} onClick={() => downloadSirenDoc(c)} style={{ padding: "6px 11px", background: "rgba(220,38,38,0.1)", border: "1px solid rgba(220,38,38,0.25)", borderRadius: 8, color: C.siren, fontSize: 11, fontWeight: 700, cursor: "pointer" }}>
                        📄 {c.keyword}
                      </button>
                    ))}
                  </div>
